...
void Node::xmlPrint(std::ostream &os, int indent) const
{
...
void NodeList::xmlPrint(std::ostream &os, int indent) const
{
...
void AnotherList::xmlPrint(std::ostream &os, int indent) const
{
...
void Super::xmlPrint(std::ostream &os, int indent) const
{
  XMLPRINT_GENERIC(x);
}
...
void Sub1::xmlPrint(std::ostream &os, int indent) const
{
...
void Sub2::xmlPrint(std::ostream &os, int indent) const
{
...
void SubWithDefault::xmlPrint(std::ostream &os, int indent) const
{
...
void Sub3::xmlPrint(std::ostream &os, int indent) const
{
...
void UsesEnum::xmlPrint(std::ostream &os, int indent) const
{
}
...
void UE_a::xmlPrint(std::ostream &os, int indent) const
{
...
void UE_b::xmlPrint(std::ostream &os, int indent) const
{
...
void InheritsSomething::xmlPrint(std::ostream &os, int indent) const
{
}
...
void IS_a::xmlPrint(std::ostream &os, int indent) const
{
...
void IS_b::xmlPrint(std::ostream &os, int indent) const
{
...
void IS_c::xmlPrint(std::ostream &os, int indent) const
{
...
void IS_d::xmlPrint(std::ostream &os, int indent) const
{
...
void HasLastArgs::xmlPrint(std::ostream &os, int indent) const
{
  XMLPRINT_GENERIC(x);
}
...
void Hla1::xmlPrint(std::ostream &os, int indent) const
{
...
void Hla2::xmlPrint(std::ostream &os, int indent) const
{
...
void SomethingElse::xmlPrint(std::ostream &os, int indent) const
{
